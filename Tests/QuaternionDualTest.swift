...
class QuaternionDualTest: XCTestCase {
  ...
  func testCompose () {
    ...
    XCTAssertEqualWithAccuracy(ad1, Double.pi, accuracy: accuracy)
    XCTAssertEqualWithAccuracy(dd1.0, 0.0, accuracy: accuracy)
    XCTAssertEqualWithAccuracy(dd1.1, 0.0, accuracy: accuracy)
    XCTAssertEqualWithAccuracy(dd1.2, 1.0, accuracy: accuracy)
  ...
  func testComposeJiaR () {
    ...
    XCTAssertEqualWithAccuracy(px.q0, 0.0, accuracy: accuracy)
    XCTAssertEqualWithAccuracy(px.q1, 0.0, accuracy: accuracy)
    XCTAssertEqualWithAccuracy(px.q2, 2.0, accuracy: accuracy)
    XCTAssertEqualWithAccuracy(px.q3, 0.0, accuracy: accuracy)
  }
  ...
  func testComposeJiaT () {
    ...
    let px = drt.transform(translation: p)
    XCTAssertEqualWithAccuracy(px.q0, 0.0, accuracy: accuracy)
    XCTAssertEqualWithAccuracy(px.q1, 2.0, accuracy: accuracy)
    XCTAssertEqualWithAccuracy(px.q2, 0.0, accuracy: accuracy)
    XCTAssertEqualWithAccuracy(px.q3, 3.0, accuracy: accuracy)
  }
