...
class FrameTest: XCTestCase {
  ...
  func checkOrientation (_ o: Orientation, frame: Frame, angle: Quantity<Angle>, axis: Frame.Axis) {
    ...
    XCTAssertEqualWithAccuracy(oq.q0, aq.q0, accuracy: accuracy)
    XCTAssertEqualWithAccuracy(oq.q1, aq.q1, accuracy: accuracy)
    XCTAssertEqualWithAccuracy(oq.q2, aq.q2, accuracy: accuracy)
    XCTAssertEqualWithAccuracy(oq.q3, aq.q3, accuracy: accuracy)
}
