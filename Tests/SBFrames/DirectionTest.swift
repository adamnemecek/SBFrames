...
class DirectionTest: XCTestCase {
  ...
  func checkValues (_ d: Direction, frame: Frame, x: Double, y: Double, z: Double) {
    ...
    XCTAssertEqualWithAccuracy(d.x, x, accuracy: accuracy)
    XCTAssertEqualWithAccuracy(d.y, y, accuracy: accuracy)
    XCTAssertEqualWithAccuracy(d.z, z, accuracy: accuracy)
  }
  
  func checkAngles (_ d: Direction, x: Double, y: Double, z: Double) {
    XCTAssertEqualWithAccuracy(d.includedAngle(axis: .x).value, x, accuracy: accuracy)
    XCTAssertEqualWithAccuracy(d.includedAngle(axis: .y).value, y, accuracy: accuracy)
    XCTAssertEqualWithAccuracy(d.includedAngle(axis: .z).value, z, accuracy: accuracy)
  }
