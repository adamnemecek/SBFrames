...
class PositionTest: XCTestCase {
  ...
  func testDirection () {
    ...
    let dx = px.direction
    XCTAssertNotNil (dx)
    XCTAssertEqualWithAccuracy(dx!.x, 1.0, accuracy: accuracy)
    XCTAssertEqualWithAccuracy(dx!.y, 0.0, accuracy: accuracy)
    XCTAssertEqualWithAccuracy(dx!.z, 0.0, accuracy: accuracy)
    ...
    XCTAssertNotNil (dxy)
    XCTAssertEqualWithAccuracy(dxy!.x, 1 / sqrt (2.0), accuracy: accuracy)
    XCTAssertEqualWithAccuracy(dxy!.y, 1 / sqrt (2.0), accuracy: accuracy)
    XCTAssertEqualWithAccuracy(dxy!.z, 0.0, accuracy: accuracy)
